...
export const ChatsChatHeader: FC<Props> = ({nickname, onCall}) => {
  return (
    <div className="chat__header h-10 flex justify-center absolute left-0 right-0">
      <div className="chat__header_wrapper border-b relative z-10 border-white/20 w-full rounded-t-xl px-4 overflow-hidden backdrop-blur-xl h-full before:bg-black/0 before:absolute before:inset-0 before:z-0 before:blur-xl">
